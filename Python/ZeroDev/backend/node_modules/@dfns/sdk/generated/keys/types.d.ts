...
export type DelegateKeyRequest = DelegateKeyParams & {
    body: DelegateKeyBody;
};
...
export type DeriveKeyRequest = DeriveKeyParams & {
    body: DeriveKeyBody;
};
...
export type ExportKeyRequest = ExportKeyParams & {
    body: ExportKeyBody;
};
